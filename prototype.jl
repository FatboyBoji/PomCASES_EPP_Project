...
function main(directory_name::String="Test1", file_prefix::String="default")
    ...
    open(summary_file, "w") do io
        ...
        @printf(io, "%-6s | %12s | %12s | %12s | %12s | %12s\n", 
               "Period", "E_toH2", "E_fromH2", "H_storage", "H_sell", "H_buy")
        println(io, "-"^100)  
        for p in 1:24
            @printf(io, "%-6d | %12.2f | %12.2f | %12.2f | %12.2f | %12.2f\n", 
    ...
    println("")
    println("H2 production efficiencies: ", η_toH2)
    println("Average H2 production efficiency: ", mean(η_toH2))
    println("H2 usage efficiencies: ", η_fromH2)
    println("Average H2 usage efficiency: ", mean(η_fromH2))
    println("")
    println("H2 Selling: ", H_sell)
    println("H2 Buying: ", H_buy)
    println("#########################################################################################")
